...
void frmInput::InitForm()
{
    ...
    {
        DbConn = QSqlDatabase::addDatabase("QSQLITE","front");
...
//    DbConn.setDatabaseName("c:/pinyin.db");
    ...
    if(!isSuccess)
    {
        qDebug() << "fonts:" <<DbConn.lastError().text();
        qDebug("DbConn.open failed");
    }
    else
    {
        qDebug() << "open db for chinese";
    }
...
void frmInput::changeType(QString type)
{
    if (type == "max") {
        changeLetter(true);
        ui->btnType->setText("Capitals");
        ui->labInfo->setText("Virtual keyboard-capitals");
        ...
        changeLetter(false);
        ui->btnType->setText("Lower");
        ui->labInfo->setText("Virtual keyboard-lowercase");
        ui->btnOther12->setText("/");
        ui->btnOther14->setText(":");
        ui->btnOther17->setText(",");
        ui->btnOther18->setText("\\");
        ...
        ui->labInfo->setText("Virtual keyboard-chinese");
        ui->btnOther12->setText("。");
        ui->btnOther14->setText("：");
        ui->btnOther17->setText("，");
        ui->btnOther18->setText("；");
