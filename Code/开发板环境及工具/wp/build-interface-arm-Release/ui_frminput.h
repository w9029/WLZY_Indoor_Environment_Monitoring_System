...
public:
    ...
    void setupUi(QWidget *frmInput)
    {
        ...
        gridLayout->addWidget(btn1, 2, 16, 1, 1);
        ...
        gridLayout->addWidget(btn8, 0, 17, 1, 1);
        ...
        gridLayout->addWidget(btn9, 0, 18, 1, 1);
        ...
        gridLayout->addWidget(btn2, 2, 17, 1, 1);
        ...
        gridLayout->addWidget(btn4, 1, 16, 1, 1);
        ...
        gridLayout->addWidget(btn3, 2, 18, 1, 1);
        ...
        gridLayout->addWidget(btn7, 0, 16, 1, 1);
        ...
        gridLayout->addWidget(btn6, 1, 18, 1, 1);
        ...
        gridLayout->addWidget(btn5, 1, 17, 1, 1);
        ...
        gridLayout->addWidget(btn00, 4, 18, 1, 1);
    ...
    void retranslateUi(QWidget *frmInput)
    {
        ...
        labInfo->setText(QApplication::translate("frmInput", "Keyboard", Q_NULLPTR));
        ...
        btnClose->setText(QApplication::translate("frmInput", "close", Q_NULLPTR));
        ...
        btnType->setText(QApplication::translate("frmInput", "Lower", Q_NULLPTR));
