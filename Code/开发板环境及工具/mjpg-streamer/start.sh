...
#/home/zzl/arm2/mjpg-streamer/mjpg_streamer -i "/home/zzl/arm2/mjpg-streamer/input_uvc.so -r 320x240 -f 10 -y" -o "/home/zzl/arm2/mjpg-streamer/output_http.so -w /home/zzl/arm2/mjpg-streamer/www"
/workspace/mjpg-streamer/mjpg_streamer -i "/workspace/mjpg-streamer/input_uvc.so -r 320x240 -f 10 -y" -o "/workspace/mjpg-streamer/output_http.so -w /workspace/mjpg-streamer/www"

#    yuan lai de
#./mjpg_streamer -i "./input_uvc.so -r 320x240 -f 15 -y" -o "./output_http.so -w ./www"
#    yuan lai de
